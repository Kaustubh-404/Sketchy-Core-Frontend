...
//           <h1 className="text-2xl font-bold mb-6 text-white">Create Game Room</h1>
...
//                 maxLength={20}
//                 className="h-12 bg-white/10 border-0 text-white placeholder-white/30 rounded-xl focus:ring-2 focus:ring-green-500/50 transition-all"
//               />
//             </div>
